            ...
            <!-- Navbar Right Menu-->
               ...
               <ul class="top-nav">
                  ...
                  <li class="dropdown notification-menu">
                    ...
                    <img class="img-circle" src="<?php echo BASE_URL; ?>admin/inc/assets/images/avatar-1.png" alt="User Image">
                  </span>
                        ...
                        <li class="bell-notification">
                           <a href="javascript:;" class="media">
                              <span class="media-left media-icon">
                    <img class="img-circle" src="<?php echo BASE_URL; ?>admin/inc/assets/images/avatar-2.png" alt="User Image">
                  </span>
                    ...
                    <img class="img-circle" src="<?php echo BASE_URL; ?>admin/inc/assets/images/avatar-3.png" alt="User Image">
                  </span>
