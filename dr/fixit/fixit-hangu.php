...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['commenter_name'])) {
    ...
    $insert_query = "INSERT INTO feedback (entity_id, commenter_name, commenter_gmail, comment, stars, status, created_at, updated_at) 
                     VALUES ('$entity_id', '$commenter_name', '$commenter_gmail', '$comment', '$stars', 'approved', NOW(), NOW())";
...
<!-- Hero Section -->
<section class="fixit-hero-section" style="background: linear-gradient(135deg, rgba(52, 152, 219, 0.8) 0%, rgba(255, 107, 53, 0.8) 100%), url('uploads/Hangu.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
    <div class="container">
        <div class="fixit-hero-content text-center" data-aos="fade-up">
            <h1 class="fixit-hero-title">Fixit <span style="color: #FF6B35;">Hangu</span></h1>
            <p class="fixit-hero-subtitle" style="color: #ffffff;">Innovative Solutions for Hangu Community</p>
            <!-- <p class="fixit-hero-description" style="color: #ffffff;">
                We are dedicated to bringing positive change and development to Hangu through technology, 
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="mission-image" data-aos="fade-right">
                    <img src="<?=BASE_URL?>fixit/uploads/Hangu.jpg" alt="Our Mission" class="img-fluid rounded-3 shadow">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mission-content" data-aos="fade-left">
                    ...
                    <p class="section-description">
                        Fixit Hangu is committed to driving positive change in our community through innovative solutions 
                        and collaborative efforts. We believe in the power of technology and community engagement to 
                        create lasting impact and improve quality of life for everyone in Hangu.
                    </p>
                    <div class="mission-values">
                        ...
                        <div class="value-item">
                            ...
                            <div class="value-content">
                                ...
                                <p>Prioritizing the needs of Hangu residents</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="projects-section section-padding" id="projects" style="background-color: #f7f7f7;">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <p class="section-subtitle">Innovative initiatives making a difference in Hangu</p>
        </div>
...
<section class="team-section section-padding" id="team" style="background: linear-gradient(135deg, #e9ecef 0%, #dee2e6 100%);">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <p class="section-subtitle">Dedicated individuals working for Hangu's development</p>
        </div>
            ...
            <div class="team-carousel-item">
                <div class="team-card-new">
                    ...
                    <div class="team-body-new">
                        ...
                        <p class="team-role-new">President Hangu Team</p>
                        <p class="team-description-new">
                            Leading the Fixit Hangu team with vision and dedication to community development
                        </p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="donate-image">
                    <img src="<?=BASE_URL?>fixit/uploads/donate.jpg" alt="Donate to Fixit Hangu" class="img-fluid rounded-3 shadow-lg">
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
                <div class="donate-content">
                    <h2 class="section-title">Donate to Fixit Hangu</h2>
                    <p class="section-subtitle">Support our mission to bring positive change to Hangu community</p>
                    
                    <div class="donate-description">
                        <p>Your generous donations help us continue our community projects and initiatives in Hangu. Every contribution makes a difference in someone's life.</p>
                    </div>
                ...
                <div class="review-form-card">
                    ...
                    <form id="fixitReviewForm" class="review-form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="comment" name="comment" rows="4" required placeholder="Share your experience with Fixit Hangu projects..."></textarea>
                        </div>
