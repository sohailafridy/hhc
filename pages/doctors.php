...
<body>
  <div class="page-shell">
    ...
    <main>
      <section class="hero-section" id="doctors-hero">
        <div class="container">
          <div class="row align-items-center g-5">
            <div class="col-lg-6">
              <div class="hero-content">
                <span class="section-kicker">Our Perfect Doctors</span>
                <h1 class="hero-title">Meet Our Professional Doctors</h1>
                <p class="hero-text">Our team of highly qualified and experienced doctors is here to provide you with the best healthcare services.</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="hero-visual">
                <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=800&q=80" alt="Our Doctors" class="w-100">
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="doctors-section section-padding" id="doctors">
        <div class="container">
                  ...
                  <article class="doctor-card">
                    <div class="position-relative overflow-hidden">
                      <?php if (!empty($doctor['img'])): ?>
                        <img src="<?php echo BASE_URL . '/' . htmlspecialchars($doctor['img']); ?>" 
